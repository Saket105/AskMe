...
public class QuestionActivity extends AppCompatActivity {
    ...
    public static final String FILE_NAME = "ASKME";
                ...
                if (list.size() > 0) {
                    ...
                    shareBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            shareIntent.putExtra(Intent.EXTRA_SUBJECT,"AskMe Challenge");
    ...
    private void enableOption(boolean enable) {
        for (int i = 0; i < 4; i++) {
            ...
            if (enable) {
                optionsContainer.getChildAt(i).setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#F5F5F5")));
            }
